...
These are dated model judgments, preserved from the previous acpx roster. Provider and execution harness are separate choices. Check the recorded date and source before a material spending decision. Read only the provider sections relevant to the available routes.
...
- **cost:**
  ...
  - **subscription_usd_per_month:** `10.0`
  - **api_usd_per_million_tokens:**
    - **input:** `0.14`
    - **cached_input:** `0.0028`
    - **output:** `0.28`
