...
Use this reference when cockpit work touches Linear structure, issue content, statuses, labels, dependencies, comments, session bindings, receipts, or workflow drift.
